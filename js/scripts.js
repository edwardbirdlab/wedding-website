   ...
   $("#bgndVideo").YTPlayer();
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            end: new Date('Dec 15, 2024 20:00'),

            // Event Address
            address: 'Will Rogers Gardens - Ed Lycan Conservatory',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact us at 918-946-4275."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b2b5eb2d12783f3f6a41b79d70609795'
            && MD5($('#invite_code').val()) !== '33f6878df804c2049e0c6733ecf3745d') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbzl3GgwX9ENeGFSp8EcRRA8BuSX1JpXzZgt93TUa4rBQAw6Tgk5AEqE_1T_SwJeyP1Qmw/exec', data)
                .done(function (data) {
                    console.log(data);
...
function initMap() {
    ...
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15, // Set a zoom level that shows both markers
        center: location1,
        scrollwheel: false
    });
